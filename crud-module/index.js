...
var ModuleGenerator = yeoman.generators.Base.extend({
  ...
  askForName: function() {
    ...
    this.prompt(
      ...
      function(props) {
        ...
        this.slugifiedName = s(this.name)
          .slugify()
          .value();

        this.slugifiedPluralName = inflections.pluralize(this.slugifiedName);
        this.slugifiedSingularName = inflections.singularize(
          this.slugifiedName
        );

        this.camelizedPluralName = s(this.slugifiedPluralName)
          .camelize()
          .value();
        this.camelizedSingularName = s(this.slugifiedSingularName)
          .camelize()
          .value();

        this.classifiedPluralName = s(this.slugifiedPluralName)
          .classify()
          .value();
        this.classifiedSingularName = s(this.slugifiedSingularName)
          .classify()
          .value();

        this.humanizedPluralName = s(this.slugifiedPluralName)
          .humanize()
          .value();
        this.humanizedSingularName = s(this.slugifiedSingularName)
          .humanize()
          .value();

        this.capitalizedSingularName = s(this.humanizedSingularName)
          .capitalize()
          .value();
  ...
  renderModule: function() {
    ...
    this.template(
      "client/config/_.client.routes.js",
      "modules/" +
        this.slugifiedPluralName +
        "/client/config/" +
        this.slugifiedPluralName +
        ".client.routes.js"
    );
    this.template(
      "client/controllers/_.client.controller.js",
      "modules/" +
        this.slugifiedPluralName +
        "/client/controllers/" +
        this.slugifiedPluralName +
    ...
    this.template(
      "client/controllers/_.list.client.controller.js",
      "modules/" +
        this.slugifiedPluralName +
    ...
    this.template(
      "client/services/_.client.service.js",
      "modules/" +
        this.slugifiedPluralName +
        "/client/services/" +
        this.slugifiedPluralName +
    ...
    this.template(
      "tests/client/_.client.controller.tests.js",
      "modules/" +
        this.slugifiedPluralName +
        "/tests/client/" +
        this.slugifiedPluralName +
    ...
    this.template(
      "tests/client/_.client.routes.tests.js",
      "modules/" +
        this.slugifiedPluralName +
        "/tests/client/" +
        this.slugifiedPluralName +
    ...
    this.template(
      "tests/client/_.list.client.controller.tests.js",
      "modules/" +
        this.slugifiedPluralName +
        "/tests/client/list-" +
        this.slugifiedPluralName +
    ...
    this.template(
      "client/views/_.form.client.view.html",
      "modules/" +
        this.slugifiedPluralName +
        "/client/views/form-" +
        this.slugifiedSingularName +
        ".client.view.html"
    );
    this.template(
      "client/views/_.view.client.view.html",
      "modules/" +
        this.slugifiedPluralName +
        "/client/views/view-" +
        this.slugifiedSingularName +
    ...
    this.template(
      "client/views/_.list.client.view.html",
      "modules/" +
        this.slugifiedPluralName +
        "/client/views/list-" +
        this.slugifiedPluralName +
    ...
    if (this.addMenuItems) {
      this.template(
        "client/config/_.client.config.js",
        "modules/" +
          this.slugifiedPluralName +
          "/client/config/" +
          this.slugifiedPluralName +
    ...
    this.template(
      "server/config/_.server.config.js",
      "modules/" +
        this.slugifiedPluralName +
        "/server/config/" +
        this.slugifiedPluralName +
    ...
    this.template(
      "server/controllers/_.server.controller.js",
      "modules/" +
        this.slugifiedPluralName +
        "/server/controllers/" +
        this.slugifiedPluralName +
    ...
    this.template(
      "server/models/_.server.model.js",
      "modules/" +
        this.slugifiedPluralName +
        "/server/models/" +
        this.slugifiedSingularName +
    ...
    this.template(
      "server/routes/_.server.routes.js",
      "modules/" +
        this.slugifiedPluralName +
        "/server/routes/" +
        this.slugifiedPluralName +
    ...
    this.template(
      "server/policies/_.server.policy.js",
      "modules/" +
        this.slugifiedPluralName +
        "/server/policies/" +
        this.slugifiedPluralName +
    ...
    this.template(
      "tests/server/_.server.model.tests.js",
      "modules/" +
        this.slugifiedPluralName +
        "/tests/server/" +
        this.slugifiedSingularName +
    ...
    this.template(
      "tests/server/_.server.routes.tests.js",
      "modules/" +
        this.slugifiedPluralName +
        "/tests/server/" +
        this.slugifiedSingularName +
