...
var ViewGenerator = yeoman.generators.Base.extend({
  askForModuleName: function() {
    ...
    var prompts = [
      ...
      },
      {
        ...
        default: "",
        message:
          "What is the name of the route (leave it blank to inherit it from module)?"
      }
    ];
    ...
    this.prompt(
      ...
      function(props) {
        ...
        this.slugifiedModuleName = s(this.moduleName)
          .slugify()
          .value();
        this.humanizedModuleName = s(this.moduleName)
          .humanize()
          .value();
        ...
        this.slugifiedName = s(this.name)
          ...
          .slugify()
          .value();
        this.classifiedName = s(this.slugifiedName)
          .classify()
          .value();
        this.humanizedName = s(this.slugifiedName)
          .humanize()
          .value();
  ...
  askForRouteDetails: function() {
    ...
    this.prompt(
      ...
      function(props) {
        ...
        this.slugifiedRoutePath = s(this.routePath)
          .slugify()
          .value();

        this.slugifiedViewName = s(this.viewName)
          .slugify()
          .value();
        this.humanizedViewName = s(this.viewName)
          .humanize()
          .value();

        this.slugifiedControllerName = s(this.controllerName)
          .humanize()
          .slugify()
          .value();
        this.classifiedControllerName = s(this.slugifiedControllerName)
          .classify()
          .value();
        this.humanizedControllerName = s(this.slugifiedControllerName)
          .humanize()
          .value();
  ...
  renderRouteViewController: function() {
    this.template(
      "_.client.controller.js",
      "modules/" +
        this.slugifiedModuleName +
        "/client/controllers/" +
        this.slugifiedControllerName +
    ...
    this.template(
      ...
      "modules/" +
        this.slugifiedModuleName +
        "/client/views/" +
        this.slugifiedViewName +
        ".client.view.html"
    );
    this.template(
      "_.client.controller.tests.js",
      "modules/" +
        this.slugifiedModuleName +
        "/tests/client/" +
        this.slugifiedControllerName +
