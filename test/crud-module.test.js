...
describe("Module Sub Generators Tests", function() {
  ...
  describe("Generate a CRUD module through the sub-generator", function() {
    beforeEach(function(done) {
      helpers
        .run(path.join(__dirname, "../crud-module"))
        .withOptions({
          "skip-install": true
        })
        .withPrompts({
    ...
    it("should generate all CRUD module files and additional folders", function() {
      ...
      assert.file(
        "modules/foos/client/controllers/list-foos.client.controller.js"
      );
      ...
      assert.file(
        "modules/foos/tests/client/list-foos.client.controller.tests.js"
      );
